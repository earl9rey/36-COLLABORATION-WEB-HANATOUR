...
기획과 디자인에서 진행한 하나투어 웹 페이지 리디자인을 바탕으로 진행했습니다.
하나투어 웹사이트를 팀원들과 함께 개발하며 UI 개선과 사용자 경험 향상에 주력했습니다. React와 Tailwind CSS를 활용해 반응형 웹으로 구현하고, API 연동을 통해 실제 데이터를 시각화했습니다.
